...
@QuarkusTest
class UppercaseExpandingBytesInStringFieldsPlaybookTest
 {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor executor;
    UppercaseExpandingBytesInStringFieldsPlaybook uppercaseExpandingBytesInStringFieldsPlaybook;
    ...
    void setup() {
        ...
        uppercaseExpandingBytesInStringFieldsPlaybook = new UppercaseExpandingBytesInStringFieldsPlaybook(testCaseListener, executor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(uppercaseExpandingBytesInStringFieldsPlaybook.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(uppercaseExpandingBytesInStringFieldsPlaybook).hasToString("UppercaseExpandingBytesInStringFieldsPlaybook");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(uppercaseExpandingBytesInStringFieldsPlaybook.skipForHttpMethods()).isEmpty();
    }
    ...
    void shouldSkipIfNotStringSchema() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"myField": 3}
                """);
        uppercaseExpandingBytesInStringFieldsPlaybook.run(data);
