...
@QuarkusTest
class UppercaseExpandingLengthInStringFieldsPlaybookTest
 {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor executor;
    UppercaseExpandingLengthInStringFieldsPlaybook uppercaseExpandingLengthInStringFieldsPlaybook;
    ...
    void setup() {
        ...
        uppercaseExpandingLengthInStringFieldsPlaybook = new UppercaseExpandingLengthInStringFieldsPlaybook(testCaseListener, executor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(uppercaseExpandingLengthInStringFieldsPlaybook.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(uppercaseExpandingLengthInStringFieldsPlaybook).hasToString("UppercaseExpandingLengthInStringFieldsPlaybook");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(uppercaseExpandingLengthInStringFieldsPlaybook.skipForHttpMethods()).isEmpty();
    }
    ...
    void shouldSkipIfNotStringSchema() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"myField": 3}
                """);
        uppercaseExpandingLengthInStringFieldsPlaybook.run(data);
