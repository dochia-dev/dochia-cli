...
@QuarkusTest
class InvalidContentLengthHeadersPlaybookTest {
    private InvalidContentLengthHeadersPlaybook invalidContentLengthHeadersPlaybook;

    @BeforeEach
    void setup() {
        invalidContentLengthHeadersPlaybook = new InvalidContentLengthHeadersPlaybook(Mockito.mock(SimpleExecutor.class));
    }
    ...
    void shouldReturnAValidHeadersList() {
        ...
        List<Set<DochiaHeader>> headers = invalidContentLengthHeadersPlaybook.getHeaders(data);
    ...
    void shouldReturn400501ResponseCode() {
        Assertions.assertThat(invalidContentLengthHeadersPlaybook.getResponseCodeFamily()).isEqualTo(ResponseCodeFamilyPredefined.FOUR00_FIVE01);
    }

    @Test
    void shouldSkipForGetAndDelete() {
        Assertions.assertThat(invalidContentLengthHeadersPlaybook.skipForHttpMethods()).contains(HttpMethod.GET, HttpMethod.DELETE);
    }
}
