...
@QuarkusTest
class LowercaseExpandingLengthInStringFieldsPlaybookTest {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor executor;
    LowercaseExpandingLengthInStringFieldsPlaybook lowercaseExpandingLengthInStringFieldsPlaybook;
    ...
    void setup() {
        ...
        lowercaseExpandingLengthInStringFieldsPlaybook = new LowercaseExpandingLengthInStringFieldsPlaybook(testCaseListener, executor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsPlaybook.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsPlaybook).hasToString("LowercaseExpandingLengthInStringFieldsPlaybook");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(lowercaseExpandingLengthInStringFieldsPlaybook.skipForHttpMethods()).isEmpty();
    }
    ...
    void shouldSkipIfNotStringSchema() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"myField": 3}
                """);
        lowercaseExpandingLengthInStringFieldsPlaybook.run(data);
