...
@QuarkusTest
class ReplaceArraysWithPrimitivesFieldsPlaybookTest
 {
    ServiceCaller serviceCaller;
    @InjectSpy
    TestCaseListener testCaseListener;
    FieldsIteratorExecutor executor;
    private ReplaceArraysWithPrimitivesFieldsPlaybook replaceArraysWithPrimitivesFieldsPlaybook;
    ...
    void setup() {
        ...
        replaceArraysWithPrimitivesFieldsPlaybook = new ReplaceArraysWithPrimitivesFieldsPlaybook(executor);
    }

    @Test
    void shouldHaveDescription() {
        Assertions.assertThat(replaceArraysWithPrimitivesFieldsPlaybook.description()).isNotBlank();
    }

    @Test
    void shouldHaveToString() {
        Assertions.assertThat(replaceArraysWithPrimitivesFieldsPlaybook).hasToString("ReplaceArraysWithPrimitivesFieldsPlaybook");
    }

    @Test
    void shouldSkipForNonBodyMethods() {
        Assertions.assertThat(replaceArraysWithPrimitivesFieldsPlaybook.skipForHttpMethods())
    ...
    void shouldSkipIfFieldPrimitive() {
        ...
        Mockito.when(data.getPayload()).thenReturn("""
                    {"primitiveField": 3}
                """);
        replaceArraysWithPrimitivesFieldsPlaybook.run(data);
