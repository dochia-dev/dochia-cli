...
class StringGeneratorTest {
    ...
    void shouldGenerateComplexEmailRegex() {
        ...
        String generated = StringGenerator.generate(regex, 1, 2000);
        Assertions.assertThat(generated).hasSizeBetween(1, 2000);
    }
    ...
    void shouldGenerateEmail() {
        ...
        schema.addExtension(DochiaModelUtils.X_DOCHIA_FIELD_NAME, "email");
