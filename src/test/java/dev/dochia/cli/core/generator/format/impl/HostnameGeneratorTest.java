...
class HostnameGeneratorTest {
    ...
    void shouldGenerate() {
        ...
        Assertions.assertThat(hostnameGenerator.generate(new Schema<>()).toString()).startsWith("www.").endsWith(".dev");
    }
    ...
    void givenAHostnameFormatGeneratorStrategy_whenGettingTheAlmostValidValue_thenTheValueIsReturnedAsExpected() {
        ...
        Assertions.assertThat(strategy.getAlmostValidValue()).isEqualTo("cool.dochia.");
    }
