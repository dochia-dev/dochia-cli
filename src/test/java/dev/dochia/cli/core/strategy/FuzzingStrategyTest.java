...
class FuzzingStrategyTest {
    ...
    @ParameterizedTest
    @CsvSource(value = {"cart", "sdochia", "bunny"})
    ...
    void shouldNotFormatWhenSimpleChars() {
        String formatted = FuzzingStrategy.formatValue("dochia");

        Assertions.assertThat(formatted).isEqualTo("dochia");
    }
    ...
    void shouldMarkText() {
        ...
        Assertions.assertThat(result).isEqualTo("dotestchia");
    }
