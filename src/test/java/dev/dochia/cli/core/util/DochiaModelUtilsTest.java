...
class DochiaModelUtilsTest {
    ...
    void shouldReturnSimpleReference(String ref, String expected) {
        String result = DochiaModelUtils.getSimpleRef(ref);
    ...
    void shouldTestEmailAndUrlNameMatches(String name, String pattern, boolean expected) {
        ...
        schema.addExtension(DochiaModelUtils.X_DOCHIA_FIELD_NAME, name);
        schema.setPattern(pattern);
        boolean result = DochiaModelUtils.isComplexRegex(schema);
    ...
    void isEmptyObjectSchema_shouldMatchExpected(String description,
                                                 Schema<?> schema,
                                                 boolean expected) {
        boolean actual = DochiaModelUtils.isEmptyObjectSchema(schema);
        assertThat(actual)
                .as(description)
                .isEqualTo(expected);
    }
