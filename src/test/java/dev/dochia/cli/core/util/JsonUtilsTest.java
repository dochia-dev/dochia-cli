...
class JsonUtilsTest {
    ...
    @ParameterizedTest
    @CsvSource({"key,dochia,kdochiaey", "anotherKey#subKey,dochia,subdochiaKey"})
    ...
    void shouldThrowAndNotBeArray() {
        boolean result = JsonUtils.isArray("[{\"test\":[{\"inner\": 4}]}]", "dochia");
    ...
    @ParameterizedTest
    @CsvSource(value = {"prop1#prop2", "prop1#prop2#prop3", "prop1#prop2#prop3#prop4", "DochiaGetSchemaget_user_users__user_id__get", "null"}, nullValues = "null")
