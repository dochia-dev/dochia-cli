...
class DSLParserTest {
    ...
    void shouldReturnSameValue() {
        String initial = "test";
        String actual = DSLParser.parseAndGetResult(initial, Map.of());
    ...
    void shouldParseValueFromOutputVariables() {
        ...
        String actual = DSLParser.parseAndGetResult(initial, Map.of("expiry", "2018-06-25"));
    ...
    void shouldSubstring() {
        ...
        String actual = DSLParser.parseAndGetResult(expression, Map.of("name", "john"));
        Assertions.assertThat(actual).isEqualTo("oh");
    }

    @Test
    void shouldGetSystemVariable() {
        String actual = DSLParser.parseAndGetResult("$$PATH", null);
        Assertions.assertThat(actual).isNotBlank();
    }

    @Test
    void shouldGetNotFoundSystemVariable() {
        String actual = DSLParser.parseAndGetResult("$$dochia", null);
        Assertions.assertThat(actual).isEqualTo("not_found_$$dochia");
    }
