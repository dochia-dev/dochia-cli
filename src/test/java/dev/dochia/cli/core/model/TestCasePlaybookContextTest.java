...
@QuarkusTest
class TestCasePlaybookContextTest {
    ...
    void givenASchema_whenGettingAllFieldsAsASingleSet_thenAllFieldsAreReturned() {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).reqSchema(baseSchema).requestPropertyTypes(this.getBasePropertiesMap()).build();
    ...
    void givenASchemaWithSubfields_whenGettingAllFieldsAsASingleSet_thenAllFieldsAreReturned() {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesMapWithSubfields()).requestPropertyTypes(this.buildRequestPropertyTypes()).reqSchema(baseSchema).build();
    ...
    void shouldLimitTheNumberOfFields() {
        ObjectSchema baseSchema = new ObjectSchema();
        baseSchema.setProperties(this.getBasePropertiesMapWithSubfields());
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesMapWithSubfields()).
    ...
    void givenAComposedSchema_whenGettingAllFields_thenAllFieldsAreReturnedIncludingTheAllOfFields() {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).reqSchema(composedSchema).requestPropertyTypes(this.getBasePropertiesMap()).build();
    ...
    void givenAComposedSchema_whenGettingAllRequiredFields_thenAllFieldsAreReturnedIncludingTheAllOfFields() {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesRequired()).requestPropertyTypes(this.getBasePropertiesRequired()).reqSchema(composedSchema).build();
    ...
    void givenAComposedSchema_whenGettingAllRequiredFieldsWithSubfields_thenAllFieldsAreReturnedIncludingTheAllOfFields() {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesMapWithSubfields()).requestPropertyTypes(this.buildRequestPropertyTypes()).reqSchema(composedSchema).build();
    ...
    void shouldIncludeBasedOnFieldType(String type, int expected) {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesMapWithSubfields())
                ...
                .build();
        Set<DochiaField> dochiaFields = data.getAllFieldsAsDochiaFields();

        Assertions.assertThat(dochiaFields).hasSize(expected);
    }
    ...
    @ParameterizedTest
    @CsvSource({"address#street,3", "dochia,4"})
    void shouldExcludeBasedOnFieldName(String name, int expected) {
        ...
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).schemaMap(getBasePropertiesMapWithSubfields())
                .requestPropertyTypes(this.buildRequestPropertyTypes())
                .reqSchema(baseSchema)
                .skippedFieldsForAllPlaybooks(List.of(name))
                .build();
        Set<DochiaField> dochiaFields = data.getAllFieldsAsDochiaFields();
    ...
    void shouldGetPowerSet() {
        ...
        Set<Set<String>> setOfFields = data.getAllFields(PlaybookData.SetFuzzingStrategy.POWERSET, 3);
    ...
    void shouldGetBasedOnSize(int maxSizeToRemove, int expected) {
        ...
        Set<Set<String>> setOfFields = data.getAllFields(PlaybookData.SetFuzzingStrategy.SIZE, maxSizeToRemove);
        Assertions.assertThat(setOfFields).hasSize(expected);
    }

    @Test
    void shouldReturnContentTypeWhenPresent() {
        PlaybookData data = PlaybookData.builder().selfReferenceDepth(4).responseContentTypes(Map.of("200", List.of("application/json", "application/v2+json"))).build();
    ...
    void shouldReturnSetOfSetsWithHalfSize() {
        ...
        Set<Set<String>> allSets = PlaybookData.SetFuzzingStrategy.getAllSetsWithMinSize(fields, 0);
    ...
    void shouldReturnSizeOfInitialSetWhenMaxFieldToRemoveBiggerThanSize() {
        Set<String> fields = Set.of("a", "b", "c", "d");
        Set<Set<String>> allSets = PlaybookData.SetFuzzingStrategy.getAllSetsWithMinSize(fields, 10);
    ...
    void shouldReturnSetsUpToMaxFieldToRemove() {
        Set<String> fields = Set.of("a", "b", "c", "d");
        Set<Set<String>> allSets = PlaybookData.SetFuzzingStrategy.getAllSetsWithMinSize(fields, 3);
