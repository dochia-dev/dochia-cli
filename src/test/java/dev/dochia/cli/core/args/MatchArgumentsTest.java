...
class MatchArgumentsTest {
    ...
    void shouldMatchLines() {
        ...
        Assertions.assertThat(matchArguments.isMatchResponse(httpResponse)).isTrue();
    }
    ...
    void shouldNotMatchLines() {
        ...
        Assertions.assertThat(matchArguments.isMatchResponse(httpResponse)).isFalse();
    }
    ...
    @Test
    void shouldNotMatchDochiaResponse() {
    ...
    @Test
    void shouldMatchDochiaResponse() {
    ...
    void shouldMatchInput(boolean matchInputFlag, String reflectedValue, boolean expected) {
        ...
        HttpResponse response = HttpResponse.builder().body("i'm a cool body").build();
