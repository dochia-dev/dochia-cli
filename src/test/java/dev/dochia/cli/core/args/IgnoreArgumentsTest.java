...
class IgnoreArgumentsTest {
    ...
    void shouldNotIgnoreLines() {
        HttpResponse httpResponse = HttpResponse.builder().responseCode(200).body("{}")
        ...
        Assertions.assertThat(ignoreArguments.isNotIgnoredResponse(httpResponse)).isFalse();
        Assertions.assertThat(ignoreArguments.isIgnoredResponse(httpResponse)).isTrue();
    }
    ...
    void shouldIgnoreLines() {
        ...
        Assertions.assertThat(ignoreArguments.isNotIgnoredResponse(httpResponse)).isTrue();
    }
    ...
    void shouldNotIgnoreRegex() {
        HttpResponse httpResponse = HttpResponse.builder().responseCode(200).body("{\"err\":\"error 333\"}")
                .numberOfLinesInResponse(200).numberOfWordsInResponse(200).contentLengthInBytes(200).build();
    ...
    void shouldIgnoreRegex() {
        HttpResponse httpResponse = HttpResponse.builder().responseCode(200).body("{\"error\":\"value\"}")
                .numberOfLinesInResponse(200).numberOfWordsInResponse(200).contentLengthInBytes(200).build();
    ...
    @Test
    void shouldNotIgnoreDochiaResponse() {
        HttpResponse httpResponse = HttpResponse.builder().responseCode(200).body("test")
                .numberOfLinesInResponse(200).numberOfWordsInResponse(200).contentLengthInBytes(200).build();
    ...
    @Test
    void shouldIgnoreDochiaResponse() {
        HttpResponse httpResponse = HttpResponse.builder().responseCode(200)
                .numberOfLinesInResponse(200).numberOfWordsInResponse(200).contentLengthInBytes(200).build();
        ReflectionTestUtils.setField(ignoreArguments, "ignoreResponseSizes", List.of(200L));
        ReflectionTestUtils.setField(ignoreArguments, "ignoreResponseWords", List.of(200L));
        ReflectionTestUtils.setField(ignoreArguments, "ignoreResponseLines", List.of(200L));
