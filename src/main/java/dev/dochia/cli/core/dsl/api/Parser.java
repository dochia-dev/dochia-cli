package dev.dochia.cli.core.dsl.api;

import java.util.Map;

/**
 * A {@code Parser} is used to interpret different types of expressions found in dochia configuration
 * files. These can range from environment variables to dynamic expression (like Spring EL).
 */
