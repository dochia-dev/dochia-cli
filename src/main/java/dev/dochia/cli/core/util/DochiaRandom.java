 ...
 */
public abstract class DochiaRandom {
     ...
     *
     * @return a random email address in the format xxx@dochia.dev
     */
    public static String email() {
        return alphabetic(10).toLowerCase(Locale.ROOT) + "@dochia.dev";
    }
