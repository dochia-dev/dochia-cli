...
/** Checks if there is a new dochia version available */
@Singleton
public class VersionChecker {
  private static final PrettyLogger LOGGER = PrettyLoggerFactory.getLogger(VersionChecker.class);
  protected static String baseUrl = "https://api.github.com/repos/dochia-dev/dochia-cli/releases/latest";
  private static final String DOWNLOAD_URL = "https://github.com/dochia-dev/dochia-cli/releases/tag/";
