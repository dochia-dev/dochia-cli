...
public class DochiaFaker {
    ...
    /**
     * Builds a new {@link DochiaFaker} by loading the {@code data.yml} resource once
    ...
    public String numerify(String pattern) {
        ...
        for (int i = 0; i < pattern.length(); i++) {
            ...
            if (c == '#') {
                result.append(DochiaRandom.instance().nextInt(10));
            } else {
                result.append(c);
            }
        }
    ...
    private String randomElement(List<String> list) {
        ...
        return list.get(DochiaRandom.instance().nextInt(list.size()));
    }
    ...
    public static class DateFaker {
        ...
        public java.time.LocalDate birthday() {
            int year = 1950 + DochiaRandom.instance().nextInt(50);
            int month = 1 + DochiaRandom.instance().nextInt(12);
            int day = 1 + DochiaRandom.instance().nextInt(28);
