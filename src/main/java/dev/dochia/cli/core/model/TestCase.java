...
import dev.dochia.cli.core.util.SimpleJsonFormatter;
...
/**
 * Entity holding a <b>dochia<b/> test case.
 */
@Getter
@Setter
...
public class TestCase {
    ...
    private static final String DOCHIA_REPLAY = "dochia replay %s";
    ...
    private String resultReason = "Everything went well";
    private String resultDetails;
    private String resultIgnoreDetails;
    private HttpRequest request = HttpRequest.empty();
    private HttpResponse response = HttpResponse.empty();
    private String path = "####";
    ...
    /**
     * dochia uses $$variable to refer to env variables, while curl needs $variable.
    ...
    /**
     * Returns the dochia replay command
     *
     * @return dochia replay command
     */
    public String getReplayCommand() {
        return DOCHIA_REPLAY.formatted(testId.replace(" ", ""));
    }
