...
public class HttpResponse {
    ...
    /**
     * Creates a HttpResponse instance with the specified parameters.
     *
     ...
     */
    public static HttpResponse from(int code, String body, String methodType, long ms) {
        return HttpResponse.builder().responseCode(code).body(body)
    ...
    public static HttpResponse empty() {
        return HttpResponse.from(INVALID_ERROR_CODE, "{}", "", 0);
    }
