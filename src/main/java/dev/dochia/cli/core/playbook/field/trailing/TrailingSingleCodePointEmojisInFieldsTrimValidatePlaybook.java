...
@EmojiPlaybook
@TrimAndValidate
public class TrailingSingleCodePointEmojisInFieldsTrimValidatePlaybook extends InvisibleCharsBaseTrimValidatePlaybook {

    /**
     * Creates a new TrailingSingleCodePointEmojisInFieldsTrimValidatePlaybook instance.
     *
     * @param sc the service caller
     * @param lr the test case listener
     * @param cp files arguments
     */
    protected TrailingSingleCodePointEmojisInFieldsTrimValidatePlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
