...
@EmojiPlaybook
@TrimAndValidate
public class LeadingSingleCodePointEmojisInFieldsTrimValidatePlaybook extends InvisibleCharsBaseTrimValidatePlaybook {

    /**
     * Creates a new LeadingSingleCodePointEmojisInFieldsTrimValidatePlaybook instance.
     *
     ...
     */
    protected LeadingSingleCodePointEmojisInFieldsTrimValidatePlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
