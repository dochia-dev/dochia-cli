...
@EmojiPlaybook
@ValidateAndTrim
public class OnlySingleCodePointEmojisInFieldsValidateTrimPlaybook extends InvisibleCharsOnlyValidateTrimPlaybook {

    /**
     * Creates a new OnlySingleCodePointEmojisInFieldsValidateTrimPlaybook instance.
     *
     ...
     */
    public OnlySingleCodePointEmojisInFieldsValidateTrimPlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp, FilterArguments fa) {
        super(sc, lr, cp, fa);
    }
