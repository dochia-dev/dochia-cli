...
/**
 * Playbook that sends minimum exact numbers in numeric fields if 'minimum' is defined.
 */
@Singleton
@FieldPlaybook
public class MinimumExactNumbersInNumericFieldsPlaybook extends ExactValuesInFieldsPlaybook {

    /**
     * Creates a new MinimumExactNumbersInNumericFieldsPlaybook instance.
     *
     * @param sc the service caller
     * @param lr the test case listener
     * @param cp files arguments
     */
    public MinimumExactNumbersInNumericFieldsPlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
