...
public class RandomLanguageIdentifiersMutator implements BodyMutator {
    ...
    public String mutate(String inputJson, String selectedField) {
        ...
        String randomKeywords = CommonUtils.random().ints(0, randomKeywordsList.size())
                .limit(4)
                .mapToObj(randomKeywordsList::get)
                .collect(Collectors.joining(" "));


        return CommonUtils.justReplaceField(inputJson, selectedField, randomKeywords).json();
    }

    private static List<String> selectRandomKeywords() {
        int randomNumber = CommonUtils.random().nextInt(15);
