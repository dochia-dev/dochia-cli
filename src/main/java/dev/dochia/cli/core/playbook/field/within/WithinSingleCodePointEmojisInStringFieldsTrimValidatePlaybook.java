...
@EmojiPlaybook
@SanitizeAndValidate
public class WithinSingleCodePointEmojisInStringFieldsTrimValidatePlaybook extends InvisibleCharsBaseTrimValidatePlaybook {

    /**
     * Creates a new WithinSingleCodePointEmojisInStringFieldsTrimValidatePlaybook instance.
     *
     * @param sc the service caller
     * @param lr the test case listener
     * @param cp files arguments
     */
    protected WithinSingleCodePointEmojisInStringFieldsTrimValidatePlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
