...
/**
 * Playbook that trails headers with single conde point emojis.
 */
@Singleton
@HeaderPlaybook
@EmojiPlaybook
public class TrailingSingleCodePointEmojisHeadersPlaybook extends BaseHeadersPlaybook {

    /**
     * Creates a new TrailingSingleCodePointEmojisHeadersPlaybook instance.
     *
     * @param headersIteratorExecutor the executor
     */
    public TrailingSingleCodePointEmojisHeadersPlaybook(HeadersIteratorExecutor headersIteratorExecutor) {
