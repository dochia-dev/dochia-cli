...
public class BaseHeadersPlaybookContext {
     ...
     */
    private final Function<DochiaHeader, ResponseCodeFamily> expectedHttpForOptionalHeadersProducer;
     ...
     */
    public Function<DochiaHeader, ResponseCodeFamily> getExpectedHttpForOptionalHeadersFuzzed() {
