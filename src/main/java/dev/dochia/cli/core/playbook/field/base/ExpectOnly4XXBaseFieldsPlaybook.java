...
/**
 * Abstract base class for playbooks expecting only 4xx responses for base fields. Extends the {@link
 ...
 */
public abstract class ExpectOnly4XXBaseFieldsPlaybook extends BaseFieldsPlaybook {

  /**
   * Constructor for initializing common dependencies for fuzzing base fields with the expectation
   * of only 4xx responses.
   *
   ...
   */
  protected ExpectOnly4XXBaseFieldsPlaybook(
