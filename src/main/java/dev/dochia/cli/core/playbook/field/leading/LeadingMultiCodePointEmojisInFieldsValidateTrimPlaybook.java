...
@EmojiPlaybook
@ValidateAndTrim
public class LeadingMultiCodePointEmojisInFieldsValidateTrimPlaybook extends LeadingMultiCodePointEmojisInFieldsTrimValidatePlaybook {

    /**
     * Creates a new LeadingMultiCodePointEmojisInFieldsValidateTrimPlaybook instance.
     *
     ...
     */
    protected LeadingMultiCodePointEmojisInFieldsValidateTrimPlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp) {
        super(sc, lr, cp);
    }
