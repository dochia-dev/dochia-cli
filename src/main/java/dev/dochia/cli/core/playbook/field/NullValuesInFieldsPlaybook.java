...
/**
 * Playbook that sends null value in fields.
 */
@Singleton
@FieldPlaybook
public class NullValuesInFieldsPlaybook extends Expect4XXForRequiredBaseFieldsPlaybook {
    private final FilterArguments filterArguments;

    /**
     * Creates a new NullValuesInFieldsPlaybook instance.
     *
     ...
     */
    public NullValuesInFieldsPlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp, FilterArguments fa) {
        super(sc, lr, cp);
