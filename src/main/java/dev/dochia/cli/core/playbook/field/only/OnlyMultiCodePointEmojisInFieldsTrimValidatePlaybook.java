...
@EmojiPlaybook
@TrimAndValidate
public class OnlyMultiCodePointEmojisInFieldsTrimValidatePlaybook extends InvisibleCharsOnlyTrimValidatePlaybook {

    /**
     * Creates a new OnlyMultiCodePointEmojisInFieldsTrimValidatePlaybook instance.
     *
     ...
     */
    public OnlyMultiCodePointEmojisInFieldsTrimValidatePlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp, FilterArguments fa) {
        super(sc, lr, cp, fa);
    }
