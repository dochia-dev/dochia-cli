...
/**
 * Playbook that sends only multi code point emojis in headers.
 */
@Singleton
@HeaderPlaybook
@EmojiPlaybook
public class OnlyMultiCodePointEmojisInHeadersPlaybook extends BaseHeadersPlaybook {

    /**
     * Creates a new OnlyMultiCodePointEmojisInHeadersPlaybook instance.
     *
     * @param headersIteratorExecutor the executor
     */
    public OnlyMultiCodePointEmojisInHeadersPlaybook(HeadersIteratorExecutor headersIteratorExecutor) {
