...
/**
 * Playbook that sends only multi code point emojis in fields.
 */
@Singleton
@FieldPlaybook
@EmojiPlaybook
@ValidateAndTrim
public class OnlyMultiCodePointEmojisInFieldsValidateTrimPlaybook extends InvisibleCharsOnlyValidateTrimPlaybook {

    /**
     * Creates a new OnlyMultiCodePointEmojisInFieldsValidateTrimPlaybook instance.
     *
     ...
     */
    public OnlyMultiCodePointEmojisInFieldsValidateTrimPlaybook(ServiceCaller sc, TestCaseListener lr, FilesArguments cp, FilterArguments fa) {
        super(sc, lr, cp, fa);
    }
