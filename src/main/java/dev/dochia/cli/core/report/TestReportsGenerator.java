...
public class TestReportsGenerator {
     ...
     *
     * @param testCase the test case to be written to the report
     */
    public void writeTestCase(TestCase testCase) {
        testCaseExporters.getFirst().writeTestCase(testCase);
    }
     ...
     */
    public void writePerformanceReport(List<TestCaseExecutionSummary> testCaseExecutionDetails) {
